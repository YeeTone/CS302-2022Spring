...
0000000000800020 <__warn>:
  ...
  800054:	6a850513          	addi	a0,a0,1704 # 8006f8 <main+0x9c>
...
00000000008000d0 <_start>:
  8000d0:	0d2000ef          	jal	ra,8001a2 <umain>
  8000d4:	a001                	j	8000d4 <_start+0x4>

00000000008000d6 <open>:
  8000d6:	1582                	slli	a1,a1,0x20
  8000d8:	9181                	srli	a1,a1,0x20
  8000da:	b7f9                	j	8000a8 <sys_open>

00000000008000dc <close>:
  8000dc:	bfd9                	j	8000b2 <sys_close>

00000000008000de <read>:
  8000de:	bff1                	j	8000ba <sys_read>

00000000008000e0 <dup2>:
  8000e0:	b7dd                	j	8000c6 <sys_dup>
...
00000000008000fc <vcprintf>:
  ...
  80010e:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6019>
  800112:	ec06                	sd	ra,24(sp)
  800114:	c602                	sw	zero,12(sp)
  800116:	1a8000ef          	jal	ra,8002be <vprintfmt>
...
0000000000800122 <cprintf>:
  ...
  80012c:	75dd                	lui	a1,0xffff7
  80012e:	f832                	sd	a2,48(sp)
  800130:	fc36                	sd	a3,56(sp)
  800132:	e0ba                	sd	a4,64(sp)
  800134:	00000517          	auipc	a0,0x0
  800138:	fae50513          	addi	a0,a0,-82 # 8000e2 <cputch>
  80013c:	0050                	addi	a2,sp,4
  80013e:	871a                	mv	a4,t1
  800140:	86f2                	mv	a3,t3
  800142:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <error_string+0xffffffffff7f6019>
  ...
  800152:	16c000ef          	jal	ra,8002be <vprintfmt>
  800156:	60e2                	ld	ra,24(sp)
  800158:	4512                	lw	a0,4(sp)
  80015a:	6125                	addi	sp,sp,96
  80015c:	8082                	ret

000000000080015e <initfd>:
  80015e:	1101                	addi	sp,sp,-32
  800160:	87ae                	mv	a5,a1
  800162:	e426                	sd	s1,8(sp)
  800164:	85b2                	mv	a1,a2
  800166:	84aa                	mv	s1,a0
  800168:	853e                	mv	a0,a5
  80016a:	e822                	sd	s0,16(sp)
  80016c:	ec06                	sd	ra,24(sp)
  80016e:	f69ff0ef          	jal	ra,8000d6 <open>
  800172:	842a                	mv	s0,a0
  800174:	00054463          	bltz	a0,80017c <initfd+0x1e>
  800178:	00951863          	bne	a0,s1,800188 <initfd+0x2a>
  80017c:	60e2                	ld	ra,24(sp)
  80017e:	8522                	mv	a0,s0
  800180:	6442                	ld	s0,16(sp)
  800182:	64a2                	ld	s1,8(sp)
  800184:	6105                	addi	sp,sp,32
  800186:	8082                	ret
  800188:	8526                	mv	a0,s1
  80018a:	f53ff0ef          	jal	ra,8000dc <close>
  80018e:	85a6                	mv	a1,s1
  800190:	8522                	mv	a0,s0
  800192:	f4fff0ef          	jal	ra,8000e0 <dup2>
  800196:	84aa                	mv	s1,a0
  800198:	8522                	mv	a0,s0
  80019a:	f43ff0ef          	jal	ra,8000dc <close>
  80019e:	8426                	mv	s0,s1
  8001a0:	bff1                	j	80017c <initfd+0x1e>

00000000008001a2 <umain>:
  8001a2:	1101                	addi	sp,sp,-32
  8001a4:	e822                	sd	s0,16(sp)
  8001a6:	e426                	sd	s1,8(sp)
  8001a8:	842a                	mv	s0,a0
  8001aa:	84ae                	mv	s1,a1
  8001ac:	4601                	li	a2,0
  8001ae:	00000597          	auipc	a1,0x0
  8001b2:	52a58593          	addi	a1,a1,1322 # 8006d8 <main+0x7c>
  8001b6:	4501                	li	a0,0
  8001b8:	ec06                	sd	ra,24(sp)
  8001ba:	fa5ff0ef          	jal	ra,80015e <initfd>
  8001be:	02054263          	bltz	a0,8001e2 <umain+0x40>
  8001c2:	4605                	li	a2,1
  8001c4:	00000597          	auipc	a1,0x0
  8001c8:	55458593          	addi	a1,a1,1364 # 800718 <main+0xbc>
  8001cc:	4505                	li	a0,1
  8001ce:	f91ff0ef          	jal	ra,80015e <initfd>
  8001d2:	02054563          	bltz	a0,8001fc <umain+0x5a>
  8001d6:	85a6                	mv	a1,s1
  8001d8:	8522                	mv	a0,s0
  8001da:	482000ef          	jal	ra,80065c <main>
  8001de:	038000ef          	jal	ra,800216 <exit>
  8001e2:	86aa                	mv	a3,a0
  8001e4:	00000617          	auipc	a2,0x0
  8001e8:	4fc60613          	addi	a2,a2,1276 # 8006e0 <main+0x84>
  8001ec:	45e9                	li	a1,26
  8001ee:	00000517          	auipc	a0,0x0
  8001f2:	51250513          	addi	a0,a0,1298 # 800700 <main+0xa4>
  8001f6:	e2bff0ef          	jal	ra,800020 <__warn>
  8001fa:	b7e1                	j	8001c2 <umain+0x20>
  8001fc:	86aa                	mv	a3,a0
  8001fe:	00000617          	auipc	a2,0x0
  800202:	52260613          	addi	a2,a2,1314 # 800720 <main+0xc4>
  800206:	45f5                	li	a1,29
  800208:	00000517          	auipc	a0,0x0
  80020c:	4f850513          	addi	a0,a0,1272 # 800700 <main+0xa4>
  800210:	e11ff0ef          	jal	ra,800020 <__warn>
  800214:	b7c9                	j	8001d6 <umain+0x34>

0000000000800216 <exit>:
  800216:	1141                	addi	sp,sp,-16
  800218:	e406                	sd	ra,8(sp)
  80021a:	e83ff0ef          	jal	ra,80009c <sys_exit>
  80021e:	00000517          	auipc	a0,0x0
  800222:	52250513          	addi	a0,a0,1314 # 800740 <main+0xe4>
  800226:	efdff0ef          	jal	ra,800122 <cprintf>
  80022a:	a001                	j	80022a <exit+0x14>
